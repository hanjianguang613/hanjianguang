/***********************************************************************************************/ 
/* pregbmiganwithoutslant: Prestack Gaussian-beam depth migration in anisotropic media(PP-wave) without local slant stack */
/* Note: The program achieved Gauss beam prestack depth migration of PP-wave common-shot records in anisotropic.
         The program is suited for VTI and TTI media, only need input relevant parameters form. 
		 The program developed from SU program.    */
/***********************************************************************************************/ 
